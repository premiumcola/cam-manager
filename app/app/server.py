...
# /api/cameras/<id>/test-alert, /api/system/telegram, /api/telegram/*
# live in routes/telegram.py since R01.5.
# /api/cameras/<id>/test-detection lives in routes/coral.py since R01.5.
...
# /api/coral/* and /api/weather/* routes live in routes/coral.py + routes/weather.py since R01.5.
