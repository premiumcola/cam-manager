...
function _showTooltipFor(p, clientX, clientY) {
  ...
  // tooltip is now text-only; auto-flip / position math still works
  // against the smaller body (the layout calculation reads the
  // measured bounding rect after first paint).
  tip.innerHTML = `
