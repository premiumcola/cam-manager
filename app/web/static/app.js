...
'eichhoernchen_orange':`<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><path d="M 52 70 Q 72 58 70 34 Q 68 18 54 20 Q 40 22 44 40 Q 48 56 52 70Z" fill="#c04010"/><path d="M 52 70 Q 66 56 64 36 Q 62 24 54 26 Q 46 28 48 42 Q 50 58 52 70Z" fill="#d4521a"/><ellipse cx="36" cy="60" rx="15" ry="11" fill="#d4521a"/><circle cx="38" cy="42" r="14" fill="#d4521a"/><circle cx="28" cy="29" r="7" fill="#d4521a"/><circle cx="28" cy="29" r="4" fill="#e06030"/><circle cx="44" cy="27" r="7" fill="#d4521a"/><circle cx="44" cy="27" r="4" fill="#e06030"/><circle cx="44" cy="39" r="3.5" fill="#111"/><circle cx="43" cy="38" r="1.2" fill="#fff"/><ellipse cx="48" cy="45" rx="5" ry="3.5" fill="#c04010"/><circle cx="50" cy="44" r="1.5" fill="#333"/><ellipse cx="28" cy="68" rx="4" ry="7" fill="#903010"/><ellipse cx="38" cy="69" rx="4" ry="6" fill="#903010"/></svg>`,
...
'eichhoernchen_hell':`<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><path d="M 52 70 Q 72 58 70 34 Q 68 18 54 20 Q 40 22 44 40 Q 48 56 52 70Z" fill="#d4b888"/><path d="M 52 70 Q 66 56 64 36 Q 62 24 54 26 Q 46 28 48 42 Q 50 58 52 70Z" fill="#c8a870"/><ellipse cx="36" cy="60" rx="15" ry="11" fill="#e8d4b0"/><circle cx="38" cy="42" r="14" fill="#e8d4b0"/><circle cx="28" cy="29" r="7" fill="#e8d4b0"/><circle cx="28" cy="29" r="4" fill="#f0e0c0"/><circle cx="44" cy="27" r="7" fill="#e8d4b0"/><circle cx="44" cy="27" r="4" fill="#f0e0c0"/><circle cx="44" cy="39" r="3.5" fill="#111"/><circle cx="43" cy="38" r="1.2" fill="#fff"/><ellipse cx="48" cy="45" rx="5" ry="3.5" fill="#d4c098"/><circle cx="50" cy="44" r="1.5" fill="#333"/><ellipse cx="28" cy="68" rx="4" ry="7" fill="#b8986a"/><ellipse cx="38" cy="69" rx="4" ry="6" fill="#b8986a"/></svg>`
};
...
const ACH_DEFS=[
  ...
  {id:'eichhoernchen_orange',  name:'Rotes Eichhörnchen',    icon:'🐿️', cat:'mammals'},
  {id:'eichhoernchen_schwarz', name:'Schwarzes Eichhörnchen',icon:'🐿️', cat:'mammals'},
  {id:'eichhoernchen_hell',    name:'Weißes Eichhörnchen',   icon:'🐿️', cat:'mammals'},
